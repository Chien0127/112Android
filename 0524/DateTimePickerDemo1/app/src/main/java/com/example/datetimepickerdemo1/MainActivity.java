package com.example.datetimepickerdemo1;
...
import java.util.Calendar; // Added import statement for Calendar
        ...
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog dlg = new DatePickerDialog(MainActivity.this,
                        MainActivity.this,
                        dt.get(Calendar.YEAR), // Corrected 'Calendar'
                        dt.get(Calendar.MONTH), // Corrected 'Calendar'
                        dt.get(Calendar.DAY_OF_MONTH)); // Corrected 'Calendar'
        ...
        btnTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TimePickerDialog dlg= new TimePickerDialog(MainActivity.this,
                        ...
                        dt.get(Calendar.HOUR), // Corrected 'Calendar'
                        dt.get(Calendar.MINUTE), false); // Corrected 'Calendar'
                dlg.show();
            }
        });
    }
